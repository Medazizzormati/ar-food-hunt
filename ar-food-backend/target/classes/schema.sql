...
-- CREATE
INSERT INTO parks (name, location, description, latitude, longitude, image_url, is_active) 
VALUES ($1, $2, $3, $4, $5, $6, $7);
...
-- UPDATE
UPDATE parks 
SET name = $2, location = $3, description = $4, latitude = $5, longitude = $6, image_url = $7, is_active = $8, updated_at = CURRENT_TIMESTAMP
WHERE id = $1;
...
-- Insert sample parks
INSERT INTO parks (name, location, description, latitude, longitude, image_url, is_active) VALUES
('Downtown Food Park', '123 Main Street, Downtown', 'The original food truck park with 10+ vendors', 40.7128, -74.0060, 'https://example.com/downtown.jpg', TRUE),
('Riverside Market', '456 River Road', 'Scenic food truck park by the river', 40.7589, -73.9851, 'https://example.com/riverside.jpg', TRUE),
('Tech Hub Food Court', '789 Innovation Drive', 'Modern food truck park in tech district', 40.7484, -73.9857, 'https://example.com/techhub.jpg', TRUE);
